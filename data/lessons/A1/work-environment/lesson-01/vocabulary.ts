...
export const vocabulary: VocabularyItem[] = [
  ...
  },
  {
    ...
    explanation: "A shared office space used by people from different companies.",
  ...
  {
    item: "along",
    explanation: "(Preposition) In a line next to something long, like a wall or a river.",
    example: "The meeting rooms are along the main hallway.",
    pronunciation: "/əˈlɔŋ/"
  },
  {
    item: "spare room",
    explanation: "An extra room in a house that is not used for a specific purpose.",
